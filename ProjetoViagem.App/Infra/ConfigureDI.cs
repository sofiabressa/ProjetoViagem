...
namespace ProjetoViagem.App.Infra
{
    public static class ConfigureDI
    {
        ...
        public static void ConfiguraServices()
        {
            ...
            Services.AddTransient<voosCadastrados, voosCadastrados>();
            ...
            Services.AddSingleton(new MapperConfiguration(config =>
            {
                ...
                .ForMember(d => d.Origem, opt => opt.MapFrom(x => new CidadeModel { Nome = x.Origem!.Nome }))
                .ForMember(d => d.Destino, opt => opt.MapFrom(x => new CidadeModel { Nome = x.Destino!.Nome }))
                .ForMember(d => d.Data_voo, opt => opt.MapFrom(x => x.Data_voo))
                .ForMember(d => d.Horario_saida, opt => opt.MapFrom(x => x.Horario_saida))
                .ForMember(d => d.Horario_chegada, opt => opt.MapFrom(x => x.Horario_chegada))
                .ForMember(d => d.NumVoo, opt => opt.MapFrom(x => x.NumVoo))
                .ForMember(d => d.ValorVoo, opt => opt.MapFrom(x => x.ValorVoo))
                .ForMember(d => d.Empresa, opt => opt.MapFrom(x => x.Empresa));
